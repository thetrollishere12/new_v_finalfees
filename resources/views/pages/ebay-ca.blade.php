...
@section('description')
Calculate & file your Canada eBay fees, eBay store, eBay Paypal fees, profits and listing upgrade fees with our Canada Ebay spreadsheet & fee calculator.
@endsection

@section('title')
Calculate Canada eBay Paypal Fee Calculator & Spreadsheet
@endsection
...
<div id="main-calculator">
	<div class="main-container">
		...
		<div class="whole-calculator">
			<h1 style="background:{{ $json['color']  }}">CANADA EBAY PAYPAL FEE CALCULATOR</h1>
			<div class="p-6">
