	...
	<div id="index-container">
		...
		<div class="about">
			<h1>TRACKING & CALCULATING THE RIGHT WAY</h1>
				...
				@if(!Auth::user())
	    			<a href="{{url('/spreadsheet')}}"><img alt="Spreadsheet System For Online Sales" class="spreadsheet-img" src="image/tracker.svg"></a>
		...
		<div class="py-10">
			...
			<div class="auto-container">
				<a href="https://chrome.google.com/webstore/detail/finalfees-tracker/ckfckhenbpkfpoagigiddcdnofklbpge?hl=en"><img alt="Spreadsheet System For Online Sales" class="auto-img m-auto" src="image/extension.svg"></a>
				<div class="auto-container">
		...
		<div class="py-10">
			...
			<div class="auto-container">
				<a href="{{url('/spreadsheet')}}"><img alt="Spreadsheet System For Online Sales" class="auto-img m-auto" src="image/auto.svg"></a>
				<div class="auto-container">
