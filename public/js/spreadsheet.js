$(document).ready(function () {
    ...
    function summary(){
        ...
        $.ajax({
            ...
            success: function (e) {
                    ...
                    a(e.sales_number.spreadsheet_sales, e.expense_number.spreadsheet_ex),
                    r(),
                    l(e.sales_number.spreadsheet_sales, e.expense_number.spreadsheet_ex);
            },
    ...
    function e(e) {
            ...
            $("#title").text($("#" + e + ".spreadsheet-name-list").text()).removeClass("summary-page"),
            $(".sub-spreadsheet").removeClass("s-click"),
            $("#" + e + ".sub-spreadsheet").slideDown(),
            $(".sub-spreadsheet").not($("#" + e + ".sub-spreadsheet")).slideUp(),
            ...
            $.ajax({
                ...
                success: function (e) {
                    console.log(e);
                        $(".load_ctn").hide(),
                        $(".spreadsheet-grid").empty().append(e.sales),
                        $(".expense-grid").empty().append(e.expense),
                        a(e.sales_number.spreadsheet_sales, e.expense_number.spreadsheet_ex),
                        r(),
                        l(e.sales_number.spreadsheet_sales, e.expense_number.spreadsheet_ex);
                },
            ...
            success: function (e) {
                for (var t = "", s = e.list, a = 0; a < s.length; a++)
                    t +=
                        ...
                        '</div><span class="icon-cog fix-btn" data-bs-toggle="modal" data-bs-target="#EditModal"></span></div>';
    ...
    $(document).on("click", ".spreadsheet-grid .pagination-ctn a", function (e) {
        e.preventDefault(), t($(this).attr("href").split("page=")[1]);
    }),

    $(document).on("click", ".expense-grid .pagination-ctn a", function (e) {
